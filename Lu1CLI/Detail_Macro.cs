        ...
        public List<string> Check_Macro(string path)
        {
            ...
            try
            {
                using (PowerShell powerShell = PowerShell.Create())
                {
                    ...
                    //Console.Write(RunningPath);
                    string Extract_Macro = string.Format("{0}\\Resources\\Extract-Macro.ps1", RunningPath);  
                    //Console.Write(Extract_Macro);
        ...
        public Suspecious Check_Suspecious(List<string> macro)
        {
            ...
            foreach (string item in macro)
            {
                using (PowerShell powerShell = PowerShell.Create())
                {
                    ...
                    string Check_Macro = string.Format("{0}\\Resources\\Check-Macro.ps1",RunningPath);
